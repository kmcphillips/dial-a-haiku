...
RSpec.describe GenerateHaikuOperation, type: :operation do
  let(:phone_call) { create(:phone_call, tree_name: "haiku_tree") }
  ...
  def stub_openai_requests(prompt:, response:)
    stub_request(:post, "https://api.openai.com/v1/completions").
      with(
        body: "{\"prompt\":\"Write a haiku about #{ prompt }\",\"model\":\"davinci-instruct-beta\",\"max_tokens\":80,\"temperature\":0.8,\"top_p\":1.0,\"frequency_penalty\":0.6,\"presence_penalty\":0.1}",
        headers: {
          'Accept'=>'*/*',
